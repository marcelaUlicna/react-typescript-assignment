...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var switchPanel_1 = __webpack_require__(13);
var taskAssigneeWrapper_1 = __webpack_require__(9);
...
var specific_1 = __webpack_require__(11);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var taskAssigneeTable_1 = __webpack_require__(8);
var TaskAssigneeSection = (function (_super) {
    ...
    TaskAssigneeSection.prototype.render = function () {
        ...
        if (this.props.users && this.props.users.length) {
            body = this.props.users.map(function (u) {
                return React.createElement(taskAssigneeTable_1.TaskAssigneeTable, { key: u.id, id: u.id, name: u.name, companyName: u.companyName, gravatar: u.gravatar, companyTags: u.companyTags, userTags: u.userTags, languages: u.languages });
            });
        }
        else {
    ...
    TaskAssigneeTable.prototype.render = function () {
        return (React.createElement("tr", null,
            React.createElement("td", { width: "25", style: this.firstCell },
                React.createElement("input", { checked: true, className: "checkbox", id: "Tasks_0__Assignees_0__Selected", name: "AdvancedAssignment.Tasks[0].Assignees[0].Selected", type: "checkbox", value: "true" })),
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var taskAssigneeSection_1 = __webpack_require__(7);
var storage_1 = __webpack_require__(1);
var TaskAssigneeWrapper = (function (_super) {
    ...
    TaskAssigneeWrapper.prototype.render = function () {
        if (this.state.isLoaded) {
            return (React.createElement("div", null, this.model.map(function (prop) {
                return React.createElement(taskAssigneeSection_1.TaskAssigneeSection, { workflow: prop.workflow, users: prop.users, key: prop.workflow.workflowId });
            })));
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var select2_1 = __webpack_require__(2);
var storage_1 = __webpack_require__(1);
